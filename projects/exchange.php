...
<section class="mt-5">
    ...
    <div class="bg-stone-100 w-full lg:w-1/2 px-5 py-8 rounded-sm dark:bg-neutral-800">
        <form action="./exchange-actions.php" method="post">
            <div class="flex flex-col gap-y-5">
                <div class="">
                    <label for="amount" class="block text-sm font-medium mb-2  dark:text-white">Amount</label>
                    <input type="number" name="amount" id="amount" class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                </div>

                <div class="grid grid-cols-2 gap-x-5">
                    <div class="col-span-1">
                        <label for="from_currency" class="block text-sm font-medium mb-2  dark:text-white">From</label>
                        <!-- Select -->
                    ...
                    <div class="col-span-1">
                        <label for="to_currency" class="block text-sm font-medium mb-2  dark:text-white">To</label>
                        <!-- Select -->
