    ...
    <main class="container mx-auto p-5">
        ...
        <section class="mt-5">
            ...
            <div class="bg-stone-200 p-4 rounded-sm dark:bg-neutral-800">
                ...
                <div class="mt-5">
                    <a href="./index.php" class="py-3 px-4 inline-flex w-full items-center justify-center gap-x-2 text-sm font-medium rounded-sm border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                        Calculate Again
                    </a>
                </div>
            </div>
